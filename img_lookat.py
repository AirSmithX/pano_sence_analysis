...
def lookat(img, center_x, center_y, new_heigh, fov):
    ...
    img = cv2.remap(img,Px,Py, cv2.INTER_LINEAR)

    print img.shape
    cv2.imshow("sas",cv2.resize(img, (img.shape[1]*3, img.shape[0]*3)))
    cv2.waitKey()
    return img

# img = cv2.imread("F:\pano256x128\indoor\living_room\pano_aybtppohkvzill.jpg")
#
# for i in range(-180, 180):
#     lookat(img, i*3.14159/180.0, 0, 90, 3.14159 * 100 / 180)
